    ...
    const fetchData = async () => {
      ...
      try {
        ...
        recentStockTransactions.forEach(trans => {
          ...
          const itemName = trans.products?.[0]?.["NAMA BARANG"] || "Item Tidak Dikenal"; // Access first element of array
          let desc = "";
        ...
        recentStockMovements.forEach(mov => {
          const itemName = mov.products?.[0]?.["NAMA BARANG"] || "Item Tidak Dikenal"; // Access first element of array

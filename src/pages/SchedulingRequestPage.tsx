...
import SchedulingRequestDetailDialog from '@/components/SchedulingRequestDetailDialog';
...
const SchedulingRequestPage: React.FC = () => {
  ...
  const [editingRequest, setEditingRequest] = React.useState<SchedulingRequest | null>(null);
  const [viewingRequest, setViewingRequest] = React.useState<SchedulingRequest | null>(null);

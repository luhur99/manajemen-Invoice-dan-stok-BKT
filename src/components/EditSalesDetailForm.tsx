...
const formSchema = z.object({
  ...
  kirim_install: z.string().min(1, "Kirim/Install harus diisi."),
  no_transaksi: z.string().min(1, "Nomor Transaksi harus diisi."),
  ...
  customer: z.string().min(1, "Nama Pelanggan harus diisi."),
  alamat_install: z.string().optional(),
  no_hp: z.string().optional(),
  type: z.string().optional(),
  qty_unit: z.number().int().min(0, "Kuantitas Unit tidak boleh negatif.").optional(),
  stock: z.number().int().min(0, "Stok tidak boleh negatif.").optional(),
  harga: z.number().min(0, "Harga tidak boleh negatif.").optional(),
  web: z.string().optional(),
  qty_web: z.number().int().min(0, "Kuantitas Web tidak boleh negatif.").optional(),
  kartu: z.string().optional(),
  qty_kartu: z.number().int().min(0, "Kuantitas Kartu tidak boleh negatif.").optional(),
  paket: z.string().optional(),
  pulsa: z.number().min(0, "Pulsa tidak boleh negatif.").optional(),
